                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('createlicensePost') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <label for="name" class="col-md-4 col-form-label text-md-right">{{ __('License Code') }}</label>

                            <div class="col-md-6">
                                <input id="title" type="text" class="form-control @error('title') is-invalid @enderror" name="license" value="{{ generate_license_key() }}" required autocomplete="off" readonly="readonly">
