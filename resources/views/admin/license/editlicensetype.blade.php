                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('updateLicenseTypePost')}}" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="title" type="text"
                                           ...
                                           value="{{ $licensetype->title }}" required autocomplete="off" autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="price" type="text"
                                           ...
                                           value="{{ $licensetype->price }}" required autocomplete="name" autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <select class="form-control @error('type') is-invalid @enderror role" name="type"
                                        ...
                                        <option value="1" {{ $licensetype->type == 1 ? 'Selected' : '' }}> Monthly
                                        </option>
                                        <option value="2" {{ $licensetype->type == 2 ? 'Selected' : '' }}> Yearly
                                        </option>
                                        <option value="3" {{ $licensetype->type == 3 ? 'Selected' : '' }}> Lifetime
                                        </option>
                                    </select>
                            ...
                            <div class="form-group row">
                                <label for="Role"
                                       class="col-md-4 col-form-label text-md-right">{{ __('Select Allowed Test') }}</label>
                                @php
                                    ...
                                    @foreach($tests as $row)
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="allowed_test[]"
                                                   id="allowed_test"
                                                   value="{{$row->name}}" {{ in_array($row->name, $allowed_test) ? 'Checked' : '' }}>
                                ...
                                <div class="col-md-6 offset-md-4">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="is_active" id="active"
                                               value="1" {{ $licensetype->is_active == '1' ? 'checked' : '' }}>
                                        ...
                                        <input class="form-check-input" type="radio" name="is_active" id="inactive"
                                               value="0" {{ $licensetype->is_active == '0' ? 'checked' : '' }}>
