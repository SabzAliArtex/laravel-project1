                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="first_name" type="text"
                                           ...
                                           name="first_name" value="{{ $user->first_name }}" required autocomplete="off"
                                           autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="last_name" type="text"
                                           ...
                                           name="last_name" value="{{ $user->last_name }}" required autocomplete="name"
                                           autofocus>
                                    ...
                                    <select class="form-control @error('role') is-invalid @enderror role" name="role">
                                        ...
                                        @foreach($roles as $role)
                                            <option value="{{ $role->id }}"
                                                    @if($role->id == $user->userrole->id) selected @endif> {{ $role->role }} </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="form-group row comission_row" style="display: none;">
                                ...
                                <div class="col-md-6">
                                    <input id="comission" type="number" max="99999" step="1" min="0"
                                           ...
                                           name="commission" value="{{ $user->commission }}" autocomplete="commission">
